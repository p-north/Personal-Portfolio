...
const BriefProjects = () => {
    const projects = [
        {id: 1, title: 'CraveIt', description: 'One-stop food finder app for all your cravings!', imag:CraveItLogo, link: 'https://github.com/p-north/StormHacks2024_CraveIt'},
        {id: 2, title: 'Transit Planner', description: 'Transit route planner for those last minute travel plans!', imag:TransitLogo, link: 'https://github.com/mini9yo/FallHacks'},
        {id: 3, title: 'Jobs Board App', description: 'Job board site where users can view or add various React dev roles!', imag: JobsLogo, link: 'https://github.com/p-north/Job_Listings_Site'},
    ];
  return (
    <div>
      <section className='py-20 bg-gray-50'>
        <div className='mx-auto px-4 sm:px-6 max-w-7xl lg:px-8'>
            <h1 className='text-3xl font-bold md:text-4xl text-center mb-10'>Featured Projects</h1>
            {/* Projects holder */}
